...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <h1 className="text-4xl font-bold text-center">{ nickname } ，請選擇您想到的地方</h1>
      <div className="flex w-full gap-4 mt-8 text-lg"> 
        ...
        <Link className="rounded-lg aspect-square flex-1 border-2 border-gray-600 flex justify-center items-center hover:bg-gray-800 hover:text-white " to="/todo">寫代辦事項</Link>
      </div>
    </div>
    )
}
